...
「社会部Gmailのパスワード共有をやめて、代理アクセスに切り替えます」という説明会で使うスライドです。全21枚、説明時間の目安は10〜15分です。

- スライド1〜5：代理アクセスとは何か、旧方式との違い（概念パート）
- スライド6〜17：実際の画面イメージを1操作ずつ見ながら理解する「①設定編（管理担当）」「②承認編（記者）」「③毎日の使い方編」
- スライド18〜21：人事異動のメリット、Gmail限定の注意、まとめ、FAQ

画面イメージはすべて、Google公式ヘルプに書かれた手順をもとに作成したオリジナルの模式図です（実際のスクリーンショットではありません）。押すべき場所は円や四角で囲み、下に目立つ色の「POINT」バーで説明を添えています。
